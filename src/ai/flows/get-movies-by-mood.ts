...
const getMoviesByMoodFlow = ai.defineFlow(
  ...
  async input => {
    ...
    } else if (input.mood.toLowerCase() === 'sad') {
        return [
          {
            title: 'Happy Ending',
            year: 2014,
            ...
            platform: 'JioCinema',
            description: 'A comedy about a writer who has writer\'s block and finds inspiration in a quirky romance.',
            imageUrl: 'https://picsum.photos/seed/happyending-sad/200/300',
            trailerUrl: 'https://www.youtube.com/watch?v=3-pI8J03-tU'
          },
          {
            title: 'Love Aaj Kal',
            ...
            platform: 'JioCinema',
            description: 'Two different love stories, one in the past and one in the present, explore the changing nature of relationships.',
            imageUrl: 'https://picsum.photos/seed/loveaajkal-sad/200/300',
            trailerUrl: 'https://www.youtube.com/watch?v=pP5e-d2I-pg'
          },
          {
            title: 'Goliyon Ki Raasleela Ram-Leela',
            ...
            platform: 'JioCinema',
            description: 'A modern adaptation of Romeo and Juliet, set in a violent, gun-trotting village in Gujarat.',
            imageUrl: 'https://picsum.photos/seed/ramleela-sad/200/300',
            trailerUrl: 'https://www.youtube.com/watch?v=L-2JyD0IerY'
          },
          {
            title: 'Ae Dil Hai Mushkil',
            ...
            platform: 'Netflix',
            description: 'A story about unrequited love, heartbreak, and the journey of two characters, Ayan and Alizeh.',
            imageUrl: 'https://picsum.photos/seed/aedilhaimushkil-sad/200/300',
            trailerUrl: 'https://www.youtube.com/watch?v=Z_POD748vyQ'
          },
          {
            title: 'Rockstar',
            ...
            platform: 'JioCinema',
            description: 'A college student chases his dream of becoming a rockstar, but his journey is filled with love, heartbreak, and fame.',
            imageUrl: 'https://picsum.photos/seed/rockstar-sad/200/300',
            trailerUrl: 'https://www.youtube.com/watch?v=ARv-v2d8L7M'
          }
        ]
    } else if (input.mood.toLowerCase() === 'funny') {
        return [
            {
                title: 'Sanam Teri Kasam',
                year: 2016,
                ...
                platform: 'JioCinema',
                description: 'A musical romantic tragedy about a librarian who is disowned by her family and falls for her brooding neighbor.',
                imageUrl: 'https://picsum.photos/seed/sanamterikasam-funny/200/300',
                trailerUrl: 'https://www.youtube.com/watch?v=1u6a-f-zK7A',
            },
            {
                title: 'Dil To Pagal Hai',
                ...
                platform: 'Prime Video',
                description: 'A classic musical love triangle between a director, his leading lady, and his best friend.',
                imageUrl: 'https://picsum.photos/seed/dil-to-pagal-hai-funny/200/300',
                trailerUrl: 'https://www.youtube.com/watch?v=pP5e-d2I-pg',
            },
            {
                title: 'Saiyaara (from Ek Tha Tiger)',
                ...
                platform: 'Prime Video',
                description: "While not a movie, 'Saiyaara' is an emotional song from 'Ek Tha Tiger' about longing and love. The film is about an Indian spy who falls for a Pakistani agent during a mission.",
                imageUrl: 'https://picsum.photos/seed/saiyaara-funny/200/300',
                trailerUrl: 'https://www.youtube.com/watch?v=pES-4V6jL4s',
            },
            {
                title: 'Ek Deewana Tha',
                ...
                platform: 'JioCinema',
                description: 'An aspiring filmmaker falls in love with a woman from a conservative Christian family, leading to a passionate but tumultuous romance.',
                imageUrl: 'https://picsum.photos/seed/ekdeewanatha-funny/200/300',
                trailerUrl: 'https://www.youtube.com/watch?v=b4l3sZ2WkL4'
            },
            {
                title: 'Om Shanti Om',
                ...
                platform: 'Netflix',
                description: 'A junior artist from the 1970s is reincarnated into the 2000s to avenge his own death and reunite with his love.',
                imageUrl: 'https://picsum.photos/seed/omshantiom-funny/200/300',
                trailerUrl: 'https://www.youtube.com/watch?v=v05013QhX-M'
            }
        ]
    }
